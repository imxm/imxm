...
* 🛡️ 120+ security engagements, most of them with [Oak Security](https://oaksecurity.io/) since 2021, earlier with [BlockApex](https://blockapex.io/), which I co-founded.
...
* 📂 Full audit portfolio with per-report findings: [imxm/audits](https://github.com/imxm/audits).
...
* A zk Circuit-bug detection: a harness over the corpus targeting under-constrained ZK circuits; example zkpassport [bug](https://github.com/zkpassport/circuits/issues/143) was dicovered


Reach out on [LinkedIn](https://www.linkedin.com/in/moazzam-arif/).
